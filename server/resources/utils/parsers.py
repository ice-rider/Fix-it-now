...
get_ticket_parser = reqparse.RequestParser()
get_ticket_parser.add_argument('id', type=int, required=True, help="This field cannot be blank.", location="json")
"""
    This parser is used to parse the get ticket request data.
